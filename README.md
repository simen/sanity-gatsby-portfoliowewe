...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/eit0lu6v/settings/api) and create a token with read rights.
